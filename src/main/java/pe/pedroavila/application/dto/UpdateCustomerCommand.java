...
public record UpdateCustomerCommand(
        @ValidOptionalString(min = 2, max = 100, message = "El nombre debe tener entre 2 y 100 caracteres.") 
        ...
        @ValidOptionalString(regexp = "^$|^[0-9]{9}$", message = "El teléfono debe tener exactamente 9 dígitos numéricos o estar vacío.") 
